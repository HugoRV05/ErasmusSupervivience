...
export default function ExpensesPage() {
  ...
  return (
    <AnimatedPage>
      <PageShell title="Expenses" subtitle={getCurrentMonthYear()}>
        {/* Total + Chart */}
              ...
              <div className="space-y-2">
                {items.map((exp) => {
                  ...
                  return (
                    <div
                      key={exp.id}
                      className="flex items-center gap-3 rounded-xl bg-card border border-border/50 p-4 group"
                    >
